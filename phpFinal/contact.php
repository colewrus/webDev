	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8"> 
						...
						<div id="hd">
							<div class="yui-gc">
								<div class="yui-u first">
									<h1>Cole Wrampelmeier</h1>
									<h2>Game Design Student & Information Services Coordinator</h2>
								</div>

								<div class="yui-u">
									<div class="contact-info">
										<h3><a id="pdf" href="resume.pdf">Download PDF</a></h3>
										<h3><a href="mailto:wrampelc@gmail.com?Subject=Website%20resume">wrampelc@gmail.com</a></h3>
									</div><!--// .contact-info -->
								</div>
							</div><!--// .yui-gc -->
						</div><!--// hd -->
				...
				<!--<object id="resume-pdf" data="resume.pdf" type="application/pdf"> 
					alt: <a href="resume.pdf"> test </a>
				</object>-->
